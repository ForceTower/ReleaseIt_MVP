...
import dev.forcetower.cubicrectangle.core.utils.AnimUtils;
 ...
 */
public class ElasticDragDismissFrameAlternative extends FrameLayout {
    ...
    public ElasticDragDismissFrameAlternative(Context context) {
        this(context, null, 0, 0);
    }

    public ElasticDragDismissFrameAlternative(Context context, AttributeSet attrs) {
